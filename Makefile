...
upload: docker_login
	docker tag last9:latest docker.pkg.github.com/last9/last9/last9:$(git rev-parse --short $TRAVIS_COMMIT)
	docker tag last9:latest docker.pkg.github.com/last9/last9/last9:latest
	docker push docker.pkg.github.com/last9/last9/last9:$(git rev-parse --short $TRAVIS_COMMIT)
	docker push docker.pkg.github.com/last9/last9/last9:latest
